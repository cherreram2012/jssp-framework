...
{
  char *str, *str_i, *str_s = "-";
  int dec, sig, len;
  bool decimalpoint = false;

  // Se convierte el valor decimal a cadena
  str = fcvt(value, precision, &dec, &sig);
...
//---------------------------------------------------------------------------
//	Devuelve la potencia de 10 enmediata enferior  menor que value.
//--------------------------------------------------------------------------- 
...
//---------------------------------------------------------------------------
//	Devuelve la potencia de 10 enmediata superior  mayor que value.
//---------------------------------------------------------------------------
