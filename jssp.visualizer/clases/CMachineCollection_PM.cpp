...
//	Constructor.
//----------------------------------------------------------------------------
CMachineCollection_PM::CMachineCollection_PM (int count)
{
...
//	Destructor.
//----------------------------------------------------------------------------
CMachineCollection_PM::~CMachineCollection_PM (void)
{
...
//----------------------------------------------------------------------------
int CMachineCollection_PM::AddMachine (char *nameMachine)
{
	if (iIndex < iSize)
	{
		MachineList[iIndex] = new char[LENGTH];
...
//
//----------------------------------------------------------------------------
int CMachineCollection_PM::SetNominalPower (unsigned index, float NominalPow)
{	
...
//----------------------------------------------------------------------------
int CMachineCollection_PM::GetIndexByName (const char *nameMachine) const
{
	for (int i = 0; i < iIndex; i++)
...
//----------------------------------------------------------------------------
const char *CMachineCollection_PM::GetNameByIndex (unsigned index) const
{	
...
//----------------------------------------------------------------------------
float CMachineCollection_PM::GetNominalPower (unsigned index) const
{
...
//----------------------------------------------------------------------------
int CMachineCollection_PM::GetMachineCount (void) const
{
	return iIndex;
}
...
//	
//----------------------------------------------------------------------------
int CMachineCollection_PM::GetMaxNameLength (void) const
{
  int len = 0, c;
...
//----------------------------------------------------------------------------
bool CMachineCollection_PM::isFull (void) const
{
...
//----------------------------------------------------------------------------
bool CMachineCollection_PM::isEmpty (void) const
{
	return (iIndex == 0) ? 1 : 0;
}

//----------------------------------------------------------------------------
//	Funcion Amiga de la clase CMachineCollection_PM. Imprime los datos miembros 
//  del objeto pasado por parametro.
//----------------------------------------------------------------------------
void PrintMachineInformation(const CMachineCollection_PM &Obj)
{
