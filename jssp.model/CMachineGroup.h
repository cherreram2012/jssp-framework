#ifndef CMachineGroup_H
#define CMachineGroup_H
...
class CMachineGroupLite {
	...
	public:
		...
		STRUCT_DATA_MACHINE GetMachineByIndex ( int index ) const;
...
class CMachineGroupExtended {
	...
	public:
		...
		const CMachineGroupLite *GetGroupLite      ( const CMachineCollection &M_list );
