...
//----------------------------------------------------------------------------
STRUCT_DATA_MACHINE CMachineGroupLite::GetMachineByIndex (int index) const
{
	STRUCT_DATA_MACHINE tmp;

	if (index < N_Machines) return MachineGroup[index];
...
//----------------------------------------------------------------------------
const CMachineGroupLite *CMachineGroupExtended::GetGroupLite (const CMachineCollection &M_list)
{
	float time;
	int machine;
	MACHINES_LIST_PTR currentPtr;
